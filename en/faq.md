...
1. Photos taken cannot be added to the No Fusion album.
2. Cannot read user-imported presets.
3. Please do not exit the widget before saving is complete, otherwise photos will be lost.
